...
namespace Business
{
    public class CommonManager
    {
        ...
        public double GetCashInTray(DateTime day)
        {
            ...
            double totalPayment = (new PaymentManager()).GetTotalPaymentForDay(day, false);
        ...
        public double GetTotalPaymentForDay(DateTime day)
        {
            return (new PaymentManager()).GetTotalPaymentForDay(day, true) + (new PaymentManager().GetTotalPaymentForDay(day, false));
        }
        ...
        public double GetTotalCreditForDay(DateTime date)
        {
            return GetTotalSaleForDay(date) - GetTotalPaymentForDay(date);
        }

        public double GetTotalSaleForDay(DateTime date)
        {
            return CommonCache.GetInstance().GetTotalSaleForDay(date);
        }
