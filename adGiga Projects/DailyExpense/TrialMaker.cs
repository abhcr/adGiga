...
namespace SoftwareLocker
{
    ...
    public class TrialMaker
    {
        ...
        /// <param name="Identifier">5 Digit string as your identifier to make password</param>
        ...
        public RunTypes ShowDialog()
        {
            ...
            RegistrationForm PassDialog = new RegistrationForm(_BaseString, _Password, DaysToEnd(), _Runed, _Text);
        ...
        // Date,DaysToEnd,HowManyTimesRan,BaseString(ComputerID)
